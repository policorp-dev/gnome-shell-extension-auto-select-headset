% gnome-shell-extension-auto-select-headset(SECTION) | User Commands
%
% "December  5 2023"
...
gnome-shell-extension-auto-select-headset - program to do something

# SYNOPSIS

**gnome-shell-extension-auto-select-headset** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gnome-shell-extension-auto-select-headset** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gnome-shell-extension-auto-select-headset** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gnome-shell-extension-auto-select-headset** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gnome-shell-extension-auto-select-headset. See **foo.conf**(5) for further details.
...
**gnome-shell-extension-auto-select-headset** provides some return codes, that can be used in scripts:
...
OEM Polilinux <oem_support@polilinux.com.br>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 OEM Polilinux
